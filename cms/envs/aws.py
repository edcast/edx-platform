...
# #EDCAST:Will remove in next SGA Upgrade
# LMS_ID = ENV_TOKENS.get('LMS_ID',EDCAST_LMS_ID)

# EDCAST_APP_ID = ENV_TOKENS.get('EDCAST_APP_ID',EDCAST_APP_ID)
# EDCAST_CALLBACK_URL = ENV_TOKENS.get('EDCAST_CALLBACK_URL',EDCAST_CALLBACK_URL)
# EDCAST_API_KEY = ENV_TOKENS.get('EDCAST_API_KEY',EDCAST_API_KEY)
# EDCAST_SHARED_SECRET = ENV_TOKENS.get('EDCAST_SHARED_SECRET',EDCAST_SHARED_SECRET)
# EDCAST_LMS_ID = ENV_TOKENS.get('EDCAST_LMS_ID',EDCAST_LMS_ID)
# EDCAST_ENVIRONMENT = ENV_TOKENS.get('EDCAST_ENVIRONMENT',EDCAST_ENVIRONMENT)
...
# # Allowed Domains
# ALLOWED_DOMAINS = ENV_TOKENS.get('ALLOWED_DOMAINS',ALLOWED_DOMAINS)
